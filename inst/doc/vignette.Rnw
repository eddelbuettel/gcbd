...
D <- subset(data[,-c(1:2,5)], type=='matmult')
D <- D[order(D[,"nobs"]),]
matplot(x=D[,"nobs"], y=D[,c(3:10)], type='l', lty=1, xlab="Matrix dimension", ylab="Time in seconds", main="Matrix Multiplication")
@

<<echo=FALSE,fig=TRUE>>=
D <- subset(data[,-c(1:2,5)], type=='matmult')
D <- D[order(D[,"nobs"]),]
matplot(x=D[,"nobs"], y=D[,c(3:10)], type='l', lty=1, xlab="Matrix dimension", ylab="Time in seconds (in logs)", main="Matrix Multiplication", log="y")
@

<<echo=FALSE,fig=TRUE>>=
D <- subset(data[,-c(1:2,5)], type=='qr')
D <- D[order(D[,"nobs"]),]
matplot(x=D[,"nobs"], y=D[,c(3:10)], type='l', lty=1, xlab="Matrix dimension", ylab="Time in seconds", main="QR Decomposition")
@

<<echo=FALSE,fig=TRUE>>=
D <- subset(data[,-c(1:2,5)], type=='qr')
D <- D[order(D[,"nobs"]),]
matplot(x=D[,"nobs"], y=D[,c(3:10)], type='l', lty=1, xlab="Matrix dimension", ylab="Time in seconds (in logs)", main="QR Decomposition", log="y")
@

<<echo=FALSE,fig=TRUE>>=
D <- subset(data[,-c(1:2,5)], type=='svd')
D <- D[order(D[,"nobs"]),]
matplot(x=D[,"nobs"], y=D[,c(3:10)], type='l', lty=1, xlab="Matrix dimension", ylab="Time in seconds", main="SVD Decomposition")
@

<<echo=FALSE,fig=TRUE>>=
D <- subset(data[,-c(1:2,5)], type=='svd')
D <- D[order(D[,"nobs"]),]
matplot(x=D[,"nobs"], y=D[,c(3:10)], type='l', lty=1, xlab="Matrix dimension", ylab="Time in seconds (in logs)", main="SVD Decomposition", log="y")
@
